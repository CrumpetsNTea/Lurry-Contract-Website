...
const LurryCarousel = () => {
  return (
    <Carousel showStatus={false} useKeyboardArrows={true} stopOnHover={false} autoPlay={true} infiniteLoop={true} interval={3000} centerMode={true} centerSlidePercentage={40} showThumbs={false}>
          <div>
              <img
